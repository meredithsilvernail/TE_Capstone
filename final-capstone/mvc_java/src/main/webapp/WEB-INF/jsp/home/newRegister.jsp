                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Become a Beer Lover!</h1>
                        </div>
                        <c:url var="formAction" value="/home/newRegister"/>
                        <form:form class="user" method="POST" action="${formAction}" modelAttribute="user">
                            <input type="hidden" name="CSRF_TOKEN" value="${CSRF_TOKEN}"/>
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <form:input type="text" class="form-control form-control-user"
                                           path="firstName" name="firstName" id="firstName" placeholder="First Name" required="true"/>
                            ...
                            <div class="form-group">
                                <form:select class="custom-select" id="role" name="role" path="role">
                        ...
                        <div class="text-center">
                            <a class="small" href="/home/newLogin">Already have an account? Login!</a>
                        </div>
                    </div>
                </div>
            </div>
