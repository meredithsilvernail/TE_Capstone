...
<c:url var="userName" value="${LOGGED_USER.userName}"/>
</c:when>
<c:otherwise>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="mainNavBar">
    <a class="navbar-brand navBrand" href="#"><i class="fas fa-beer" id="beerLogo"></i>Brewery Finder</a>
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown no-arrow navLinks">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="mr-2 d-none d-lg-inline text-gray-600 small navLinks">${userName}<i id="cheersLogo" class="fas fa-glass-cheers"></i></span>
                </a>
